...
String cvstring;
    ...
    QString filename;
    if(picks){
    filename= "D:/programming/R/data/thresh"+QString::number(min)+"scan"+QString::number(scantype)+"ms.txt";
    }
    else{
        filename= "D:/programming/R/data/thresh"+QString::number(min)+"scan"+QString::number(scantype)+".txt";
    }
       ...
       stream<<"minimPerim   maximPerim   deviatiePerim    mediePerim   minimArie   maximArie   deviatieArie    medieArie  tip \n"<<minimu<<endl;
       }
}
